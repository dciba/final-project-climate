...
future= input('For how many years after 2017 would you like to predict the change in Ocean Heat Content?');
...
polybestfit5= polyval(cbestfitpoly5,newyears);

%subplot of polynomial best fit (degree of 5)
subplot(2,2,3);
plot(newyears,polybestfit5,'-.g');
xlabel('year');
ylabel('ocean heat content (zettajoules)');
...
polybestfit10= polyval(cbestfitpoly10,newyears);

%subplot of polynomial best fit (degree of 10)
subplot(2,2,4);
plot(newyears,polybestfit10,'-.m');
xlabel('year');
ylabel('ocean heat content (zettajoules)');
